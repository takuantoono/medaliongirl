...
BattleManager.processEscape = function() {
    ...
    var escape_pot = this._escapeRatio * ($gameParty.agility() * ($gameVariables.value(484)+100)/100) / 
		($gameTroop.agility());
		console.log("escape:"+escape_pot)
    var success = this._preemptive ? true : (Math.random() < escape_pot);
    if (success) {
