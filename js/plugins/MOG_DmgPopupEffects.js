...
Sprite_Battler.prototype.setupDamagePopup = function() {
    if (this._battler.isDamagePopupRequested()) {
        if (this._battler.isSpriteVisible()||this._battler.isActor()) {
            var sprite = new Sprite_Damage();
            if(this._battler.isActor()){
            sprite.x = 80;
            var index = $gameParty.members().indexOf($gameActors.actor(this._battler._actorId));
            sprite.y = this._homeY+62 + index*3;
            }else{
