...
Scene_Shop.prototype.onNumberOk = function() {
	if($gameSwitches._data[419]&&!$gameSwitches._data[1010]){
	AudioManager.playSe({"name":"one22","volume":90,"pitch":150,"pan":0});
	}else{
    if($gameVariables.value(148)==0){
