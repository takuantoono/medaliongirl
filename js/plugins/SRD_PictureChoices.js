...
Game_Message.prototype.setChoices = function(choices, defaultType, cancelType) {
	...
	if(!$gameMessage.isPictureChoices){
	if(SceneManager._scene._directionalPad && $gameMessage.choices().length > $gameMessage._choiceMaxRow)SceneManager._scene._directionalPad.show();
	}
};
...
Window_PictureChoiceList.prototype.updatePlacement = function() {
	...
	this.y = (Graphics.boxHeight - this.height) / 2 +10;
