...
(function () {
    ...
    for (var i = 0; i < icons.length; i++) {
        ...
        width = width || 144;
        var areaName = 'stateIcons_actor' + actor._actorId;
        if($gameSwitches.value(521))this.areaManager.unregister(areaName);
        ...
        for (var i = 0; i < icons.length; i++) {
            ...
            //if(actor.isStateAffected(1))console.log(panel);;
