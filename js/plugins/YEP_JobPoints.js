...
Window_Base.prototype.drawActorClass = function(actor, wx, wy, ww) {
	...
	name = this.specialClass(actor, name);
    this.drawText(name, wx, wy, ww);
    if (!this._drawMenuJP) return;
    var classId = actor.currentClass().id;
    this.drawActorJp(actor, classId, wx+80, wy, ww, 'right');
};

Window_Base.prototype.specialClass = function(actor, name){
    if(actor.isStateAffected(331))name=$dataStates[331].name;
    if(actor.isStateAffected(332))name=$dataStates[332].name;
    if(actor.isStateAffected(333))name=$dataStates[333].name;
    if(actor.isStateAffected(334))name=$dataStates[334].name;
    if(actor.isStateAffected(335))name=$dataStates[335].name;
    if(actor.isStateAffected(336))name=$dataStates[336].name;
    if(actor.isStateAffected(337))name=$dataStates[337].name;
    if(actor.isStateAffected(338))name=$dataStates[338].name;
    if(actor.isStateAffected(339))name=$dataStates[339].name;
    if(actor.isStateAffected(340))name=$dataStates[340].name;
    if(actor.isStateAffected(341))name=$dataStates[341].name;
    if(actor.isStateAffected(342))name=$dataStates[342].name;
    if(actor.isStateAffected(343))name=$dataStates[343].name;
    if(actor.isStateAffected(344))name=$dataStates[344].name;
    if(actor.isStateAffected(345))name=$dataStates[345].name;
    if(actor.isStateAffected(346))name=$dataStates[346].name;
    if(actor.isStateAffected(347))name=$dataStates[347].name;
    if(actor.isStateAffected(348))name=$dataStates[348].name;
    if(actor.isStateAffected(349))name=$dataStates[349].name;
    if(actor.isStateAffected(350))name=$dataStates[350].name;
    if(actor.isStateAffected(351))name=$dataStates[351].name;
    if(actor.isStateAffected(352))name=$dataStates[352].name;
    if(actor.isStateAffected(353))name=$dataStates[353].name;
    if(actor.isStateAffected(354))name=$dataStates[354].name;
    return name;
};

Window_Base.prototype.amaClass = function(actor, name){
    if(actor.isStateAffected(400))name=$dataStates[400].name;
    if(actor.isStateAffected(401))name=$dataStates[401].name;
    if(actor.isStateAffected(402))name=$dataStates[402].name;
    if(actor.isStateAffected(403))name=$dataStates[403].name;
    if(actor.isStateAffected(404))name=$dataStates[404].name;
    if(actor.isStateAffected(405))name=$dataStates[405].name;
    if(actor.isStateAffected(406))name=$dataStates[406].name;
    if(actor.isStateAffected(407))name=$dataStates[407].name;
    if(actor.isStateAffected(408))name=$dataStates[408].name;
    if(actor.isStateAffected(409))name=$dataStates[409].name;
    if(actor.isStateAffected(410))name=$dataStates[410].name;
    return name;
};
