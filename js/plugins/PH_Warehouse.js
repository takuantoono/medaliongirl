...
(function() {
    ...
    Window_WarehouseCategory.prototype.initialize = function() {
        ...
        this.y = this.fittingHeight(3) + 10;
        this.deselect();
        this.deactivate();
    };
    ...
    Window_WarehouseInfo.prototype.refresh = function() {
		...
		this.drawText($gameVariables.value(248) + " " + u.toFixed(1) + "/" + t, 450, 0);
      	if($gameVariables.value(147) != 0 && !$gameSwitches.value(242)) this.drawText(text, 0, 0, 100, 'right');
    };
