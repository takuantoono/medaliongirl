...
-------------------------------------------------------------------------
@plugindesc Create your own page conditions for your events using
regular eventing!
@help 
-------------------------------------------------------------------------
== Description ==
...
(function ($) {
  ...
  PageManager.conditionsMet = function(list, eventId) {
    this._interpreter.setup(list, eventId);
  ...
  Game_Event.prototype.meetsCustomConditions = function(page) {
    ...
    if (page.customPageCondition.length > 0) {
      return PageManager.conditionsMet(page.customPageCondition, this._eventId)
    }
    return true;
  };
  ...
  Game_Troop.prototype.meetsConditions = function(page) {
    ...
    return this.customPageConditionsMet(page);
  };
