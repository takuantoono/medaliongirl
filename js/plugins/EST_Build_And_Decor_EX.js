...
Game_Interpreter.prototype.decorSelect = function(type, del, posfix) {
	...
	this._params = [EST.Build_And_Decor.varId];
	    if(!$gameSwitches._data[1010])$gameSwitches.setValue(268,true)
	this.command104();
	        if(!$gameSwitches._data[1010])$gameSwitches.setValue(603,true)
};
...
Window_EventItem.prototype.includes = function(item) {
	...
	if($gameSwitches.value(574) && item && item._itypeId != 1)return false;
	}
	}
