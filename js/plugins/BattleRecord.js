...
(function() {
    ...
    Game_BattlerBase.prototype.recordSkillUseCounter = function(skillId) {
        ...
        if(actor._equips[1]&&actor._equips[1]._dataClass!="weapon"){
		var shield = $dataArmors[actor._equips[1]._itemId];
		if(shield&&shield.meta.no_count==skillId){
		return;
		}
		};
        };
    ...
    Game_Battler.prototype.useItem = function(item) {
        ...
        if ($gameParty.inBattle()||item.meta.docount){
    ...
    Scene_Shop.prototype.doBuy = function(number) {
        ...
        console.log(number * this.buyingPrice())
