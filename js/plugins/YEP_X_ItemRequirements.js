...
ItemManager.checkUsableItemRequirement = function(line, item, battler) {
  ...
  // Item
  if (line.match(/Item15:(.*)/i)) {
    return this.usableItemRequirementItem15();
  }
  // NOT ACTOR
...
ItemManager.usableItemRequirementItem15 = function() {
  return $gameParty.numItems($dataItems[15]) < 50;
};
