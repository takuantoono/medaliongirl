...
// ** TOWNS
//=============================================================================	
    Moghunter.fastTravel_Towns[1] = {name:"セスカム郊外",x:550,y:387,mapID:21,mapX:9,mapY:19,direction:8};
    Moghunter.fastTravel_Towns[2] = {name:"西の森 東出口",x:530,y:380,mapID:30,mapX:25,mapY:16,direction:4};
    Moghunter.fastTravel_Towns[3] = {name:"西の森 西出口",x:510,y:375,mapID:32,mapX:19,mapY:14,direction:4};
//=============================================================================
// ** DUNGEONS
//=============================================================================	
...
SceneFastTravel.prototype.refreshStage = function() {
     ...
     console.log(this._currentData.mapID)
     if(this._currentData.mapID==30) vid = 592;
     if(this._currentData.mapID==21) vid = 593;
     if(this._currentData.mapID==32) vid = 594;
     var message = " "
     if(vid != 0){
     ...
     if(!$gameSwitches.value(234)) this._comp.bitmap.drawText(message,70,100,350,32, "left");
...
SceneFastTravel.prototype.updateCommand = function() {
     if (Input.isRepeated('left') || Input.isRepeated('pagedown')) {
		 ...
		 if(!$gameSwitches.value(234)) this.executeCancel();
